...
print*, '**Colsed integer power of 2 for number **', nvdata,  ' **is** ', nc
print*, '**number of correlation data **', nc/2
print*, '**Colsed integer power of 2 for number**', nvdata/2,  '**is**',  nc_fft
! 
!********************For IR spectra *********************
...
print*, '**Colsed integer power of 2 for number **', ndata,  ' **is** ', nc_ir
print*, '**number of correlation data **', nc_ir/2
print*, '**Colsed integer power of 2 for number**', ndata,  '**is**',  nc_ir_fft
! 
